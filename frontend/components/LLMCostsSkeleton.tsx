...
export function LLMCostsSkeleton() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-8 animate-pulse">
      ...
      {/* Model Breakdown Chart Skeleton */}
      <div className="rounded-2xl border border-slate-200 bg-white p-6 space-y-4">
        <div className="h-6 w-48 rounded-lg bg-slate-200 border-b border-slate-100 pb-3" />
